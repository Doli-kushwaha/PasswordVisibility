...
<form action="<?php echo base_url()?>Password_Controller/addpass" method="post" style="max-width:500px;margin:auto">
...
<input type="checkbox" onclick="passverify()"> show password
